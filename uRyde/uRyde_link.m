...
@interface uRyde_link ()
@end

@implementation uRyde_link

- (void)initSinchClient:(NSString*)userId {
    self.sinchClient = [Sinch clientWithApplicationKey: @"728f3ab4-a1d6-45d6-9db8-01a9003fb82e"
                                     applicationSecret: @"4H4nXopLk0aMHqAmicusiA=="
